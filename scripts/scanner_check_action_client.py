...
import time
import actionlib
from turtlebot_maze_solver.msg import RecordOdomGoal, RecordOdomFeedback, RecordOdomResult, RecordOdomAction
...
client = actionlib.SimpleActionClient('/rec_odom_as', RecordOdomAction)
